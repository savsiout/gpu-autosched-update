...
int main(int argc, char **argv) {
    ...
    for(int i=0;i<16;i++){
    if(i<4){
    br1_gamma[i].set_host_dirty();
    br1_beta[i].set_host_dirty();
    br1_mu[i].set_host_dirty();
    br1_sig[i].set_host_dirty();
    br1_conv_weights[i].set_host_dirty();
    }
    
    br2a_gamma[i].set_host_dirty();
    br2b_gamma[i].set_host_dirty();
    br2c_gamma[i].set_host_dirty();
    br2a_beta[i].set_host_dirty();
    br2b_beta[i].set_host_dirty();
    br2c_beta[i].set_host_dirty();
    
    br2a_mu[i].set_host_dirty();
    br2b_mu[i].set_host_dirty();
    br2c_mu[i].set_host_dirty();
    br2a_sig[i].set_host_dirty();
    br2b_sig[i].set_host_dirty();
    br2c_sig[i].set_host_dirty();
    br2a_conv_weights[i].set_host_dirty();
    br2b_conv_weights[i].set_host_dirty();
    br2c_conv_weights[i].set_host_dirty();
    }
    output.set_host_dirty();
    conv1_gamma.set_host_dirty();
    conv1_beta.set_host_dirty();
    conv1_mu.set_host_dirty();
    conv1_sig.set_host_dirty();
    conv1_weights.set_host_dirty();
    fc1000_bias.set_host_dirty();
     fc1000_weights.set_host_dirty();
